...
export const errorsDictionary: errorsDictionaryInterface = {
  ...
  ["jobDescription.string.min"]:
    "Job Description must have at least 2 characters.",
  ...
  ["password.string.pattern.base"]:
    "Your password must be between 8 and 12 characters long.",
  ["password.string.empty"]: "Please type in a valid password. Your password must be between 8 and 12 characters long.",
